...
func opcodeCheckLockTimeVerify(op *ParsedOpcode, t *thread) error {
	...
	lockTime, err := NewNumber(so, 5, t.dstack.verifyMinimalData, t.cfg.AfterGenesis())
	if err != nil {
		return err
	}
...
func opcodeCheckSequenceVerify(op *ParsedOpcode, t *thread) error {
	...
	stackSequence, err := NewNumber(so, 5, t.dstack.verifyMinimalData, t.cfg.AfterGenesis())
	if err != nil {
		return err
	}
...
func opcodeNum2bin(op *ParsedOpcode, t *thread) error {
	...
	sn, err := NewNumber(a, len(a), false, t.afterGenesis)
	if err != nil {
		return err
	}
