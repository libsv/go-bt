...
func TestGetSighashPayload(t *testing.T) {
	...
	tx.Inputs[0].PreviousTxScript = transaction.NewScriptFromString("76a9148fe80c75c9560e8b56ed64ea3c26e18d2c52211b88ac")
	// t.Logf("%x\n", tx.Hex())
...
func TestSignTxForced(t *testing.T) {
	...
	tx.Inputs[0].PreviousTxScript = transaction.NewScriptFromString("a914d3f9e3d971764be5838307b175ee4e08ba427b908876a914c28f832c3d539933e0c719297340b34eee0f4c3488ac")
...
func TestValidSignature(t *testing.T) {
	...
	var previousTxScript *transaction.Script = transaction.NewScriptFromString("76a914c7c6987b6e2345a6b138e3384141520a0fbc18c588ac")
...
func TestValidSignature2(t *testing.T) {
	...
	var previousTxScript *transaction.Script = transaction.NewScriptFromString("76a914343cadc47d08a14ef773d70b3b2a90870b67b3ad88ac")
...
func TestBareMultiSigValidation(t *testing.T) {
	...
	var previousTxScript *transaction.Script = transaction.NewScriptFromString("5221023ff15e2676e03b2c0af30fc17b7fb354bbfa9f549812da945194d3407dc0969b21039281958c651c013f5b3b007c78be231eeb37f130b925ceff63dc3ac8886f22a32103ac76121ffc9db556b0ce1da978021bd6cb4a5f9553c14f785e15f0e202139e3e53ae")
	var prevIndex uint32 = 0
	var outIndex uint32 = 0
...
func TestP2SHMultiSigValidation(t *testing.T) { // NOT working properly!
	...
	var previousTxScript *transaction.Script = transaction.NewScriptFromString("5221021db57ae3de17143cb6c314fb206b56956e8ed45e2f1cbad3947411228b8d17f1210308b00cf7dfbb64604475e8b18e8450ac6ec04655cfa5c6d4d8a0f3f141ee419421030c7f9342ff6583599db8ee8b52383cadb4cf6fee3650c1ad8f66158a4ff0ebd953ae")
	var prevIndex uint32 = 1
	var outIndex uint32 = 0
