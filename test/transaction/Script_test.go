...
func TestIsPublicKeyHashOut(t *testing.T) {
	...
	scriptPub := transaction.NewScriptFromBytes(b)
...
func TestGetPublicKeyHash(t *testing.T) {
	...
	s := transaction.NewScriptFromBytes(b)
...
func TestGetPublicKeyHashAsString(t *testing.T) {
	s := transaction.NewScriptFromString("76a91404d03f746652cfcb6cb55119ab473a045137d26588ac")
