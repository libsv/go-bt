...
// TODO: move to address/script package using proper funcs?
...
// 	script, err := block.AddressToScript("1DkmRkb5iQFkDu4NBysog5bugnsyx7kwtn")
// 	if err != nil {
// 		t.Error(err)
// 	} else {
...
// 	script, err := block.AddressToScript("37BvY7rFguYQvEL872Y7Fo77Y3EBApC2EK")
// 	if err != nil {
// 		t.Error(err)
// 	} else {
// 		h := hex.EncodeToString(script)
...
// 	_, err := block.AddressToScript("ADD8E55")
// 	if err == nil {
...
// 	_, err := block.AddressToScript("27BvY7rFguYQvEL872Y7Fo77Y3EBApC2EK")
// 	if err == nil {
// 		t.Errorf("Expected an error")
// 	} else {
