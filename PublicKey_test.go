...
func TestNewPublicKey(t *testing.T) {
	p, err := NewPublicKey("xpub661MyMwAqRbcFCY8gDwbuGXzaissPEB7QBGdktacSbuwPiXdftuKxCttUPAMxw7ezZ2DEcC9hPcoz5AK3S3corSXx5F1s3MNiqCBbQztkR4")
	if err != nil {
		t.Error(err)
		return
	}
