...
func TestGetTotalOutputSatoshis(t *testing.T) {
	tx, err := transaction.NewFromString("")
	if err != nil {
		t.Error(err)
	}
...
func TestSignTx(t *testing.T) {
	...
	signer := transaction.InternalSigner{PrivateKey: wif.PrivKey, SigType: 0}
	err = tx.Sign(&signer)
	if err != nil {
		t.Fatal(err)
	}
