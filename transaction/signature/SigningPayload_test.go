...
// 	payload := Signature.NewSigningPayload()
...
// 	var payload Signature.SigningPayload
...
// // 	tx, err := transaction.NewFromHexString(unsignedTx)
// // 	if err != nil {
// // 		t.Error(err)
// // 		return
// // 	}

// // 	signingPayload := transaction.NewSigningPayload()
...
// // 	tx.Inputs[0].PreviousTxScript = transaction.NewFromHexString("76a914bcd0bdbf5fcde5ed957396752d4bd2e01d36870288ac")
// // 	tx.Inputs[1].PreviousTxScript = transaction.NewFromHexString("76a914bcd0bdbf5fcde5ed957396752d4bd2e01d36870288ac")
...
// 	actualSigHash := Signature.GetSighashForInput(tx, transaction.SighashAll|transaction.SighashForkID, uint32(0))
// 	if err != nil {
// 		t.Error(err)
// 		return
// 	}
