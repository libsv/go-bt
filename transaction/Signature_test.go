...
func TestSigHash(t *testing.T) {
	...
	bt.Inputs[0].PreviousTxScript = NewScriptFromString("76a91403ececf2d12a7f614aef4c82ecf13c303bd9975d88ac")
...
func TestSigHashDave(t *testing.T) {
	...
	bt.Inputs[0].PreviousTxScript = NewScriptFromString("76a914c0a3c167a28cabb9fbb495affa0761e6e74ac60d88ac")
